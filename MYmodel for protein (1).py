...
# -------------------- 训练准备 --------------------
def prepare_dataloaders(sequences, labels, extractor , batch_size=32, test_size=0.2, val_size=0.1, max_length=512):
    """
    准备数据加载器
    ...
    # 预计算所有特征
    print("预计算特征...")
    all_features = extractor.extract_features(sequences,max_workers=16)
...
if __name__ == '__main__':
    ...
    uniprot_file = 'uniprot_sprot.dat' # <--- 把你的文件名放在这里
